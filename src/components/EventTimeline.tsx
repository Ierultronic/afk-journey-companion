        ...
        return (
          <div key={section.label}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className={`text-xs px-2 py-0.5 rounded-full ${section.color} border`}>
                {sorted.length}
              </span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-stretch gap-0">
                      {start && (
                        <div className={`flex flex-col items-center justify-center min-w-[72px] px-3 py-4 border-r ${
                          isActive ? 'border-green-600/30' : 'border-gray-700'
                        }`}>
                          ...
                          {end && end.month !== start.month && (
                            <>
                              ...
                              <span className="text-xs uppercase tracking-wider text-gray-400">{end.month}</span>
                              <span className={`text-lg font-bold ${isActive ? 'text-green-400' : 'text-white'}`}>{end.day}</span>
                            </>
                          )}
                          {end && end.month === start.month && (
